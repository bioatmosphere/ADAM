...
Data: https://www.worldwildlife.org/publications/terrestrial-ecoregions-of-the-world
...
shapefile_path = '../landcover/data/official/wwf_terr_ecos.shp'
...
try:
    ...
    gdf.plot(ax=ax,
             column='ECO_NAME',           # Color by BIOME field
             legend=False,              # Show legend
             legend_kwds={'title': 'Ecosystem Types',
                     'bbox_to_anchor': (.5, 0.01),  # Position legend outside
                     'loc': 'lower center',        # Location of legend
                     'ncol': 3,                    # Number of columns
                     'fontsize': 6,                # Legend text size
                     'title_fontsize': 10,         # Title text size
    ...
    plt.gcf().set_size_inches(18, 10)  # Width increased for legend
    ...
    output_path = os.path.join(output_dir, 'Olson_biomes_map.pdf')
