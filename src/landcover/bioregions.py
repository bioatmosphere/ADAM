...
Data: https://www.oneearth.org/bioregions/
...
def plot_static_map(gdf):
    ...
    numerical_column = 'Shape_Area' # EXAMPLE - CHANGE IF NEEDED, or use calculated area
...
if __name__ == "__main__":
    ...
    geojson_file_path = "../landcover/data/one_earth-bioregions-2023.geojson" 
